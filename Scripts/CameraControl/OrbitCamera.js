...
OrbitCamera.attributes.add("CenterPoint",{
    type:"entity",
    description:"摄像机的中心点"
});
...
{      
    ...
    this._targetYaw  =  y; //如果外部传来的值大，就需要做这步处理 
...
{  
    if((0 > e) || (e > 360))
    {
        var a = (e - e % 360) + parseFloat(t);
        return a;
    } 
    return t;  
};
OrbitCamera.prototype.change = function(center)
{
    this.pivotPoint = center;
};
...
OrbitCamera.prototype.initialize = function () {
    ...
    setTimeout(this.changeCenter(),1000);
    
};
OrbitCamera.prototype.changeCenter = function()
{
    this.entity.lookAt(this.CenterPoint);
    this._pivotPoint.copy(this._modelsAabb.center);
};
